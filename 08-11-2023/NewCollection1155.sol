...
contract NFT1155 is ERC1155, Ownable, ReentrancyGuard, EIP712, ERC2981{
    ...
    )Ownable(initialOwner) ERC1155("") EIP712(dapp, version) ReentrancyGuard() {
    ...
    function directMint(address account, uint256 id, uint256 amount, bytes memory data,address _royaltyfeerecipient, uint96 _royalty)
        public
        onlyOwner
    {
        _mint(account, id, amount, data);
        _setTokenRoyalty(id, _royaltyfeerecipient, _royalty);
    }
