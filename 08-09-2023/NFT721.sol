    ...
    AccessControl
{
        ...
        return
            _hashTypedDataV4(
                keccak256(
                    abi.encode(
                        keccak256(
                            "NFTVoucher(string name,string description,uint256 tokenId,uint256 minPrice,string uri,address creator,address token,uint256 nonce)"
                        ),
    ...
    function supportsInterface(
        bytes4 interfaceId
    ) public view virtual override(AccessControl, ERC721URIStorage,ERC721) returns (bool) {
        return
...
//0x99aE8957F215b48F98E76AE34146218Eb0FB2752 - Sepolia Testnet
